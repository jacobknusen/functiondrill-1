...
function faveColorFinder(color){
  if( color === 'red'){
    ...
    console.log('so tredy')
  }else {console.log('you need to evluate your favorite color choice')}
...
}   else {console.log("that is indeed odd!")
}
}
oddChecker = thatsOdd(10)
